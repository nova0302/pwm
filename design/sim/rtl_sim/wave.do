...
add wave -noupdate /act_tb/DUT/t_signal
add wave -noupdate /act_tb/DUT/t_shift_signal
add wave -noupdate /act_tb/DUT/t_duty_cnt
add wave -noupdate /act_tb/DUT/t_period_cnt
add wave -noupdate /act_tb/DUT/tpwm_out_delay
add wave -noupdate /act_tb/DUT/t1_cnt
add wave -noupdate /act_tb/DUT/t2_cnt
add wave -noupdate /act_tb/DUT/t3_cnt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {118181 ps} 0}
